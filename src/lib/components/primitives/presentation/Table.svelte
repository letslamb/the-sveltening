<script>
  ...
  import SortArrow from '$lib/components/utils/SortArrow.svelte'
...
<style>
  ...
  :global(.lists-container > * > h3), 
  :global(.lists-container > * > h4), 
  :global(.lists-container > * > h5), 
  :global(.lists-container > * > h6) {
    background: #000;
    color: #fff;
    padding: 0.5rem;
  }
